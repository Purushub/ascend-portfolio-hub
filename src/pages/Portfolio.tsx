...
const Portfolio = () => {
  ...
  const themeClasses = {
    ...
    wholesome: {
      wrapper: "min-h-screen bg-gradient-to-br from-amber-50 via-rose-50 to-green-50 font-nunito",
      header: "bg-gradient-to-r from-amber-100 to-rose-100 text-amber-900 py-10 px-6 shadow-md",
      headerTitle: "text-4xl font-bold mb-2 text-amber-900",
      headerSubtitle: "text-lg text-amber-800",
      button: "bg-amber-200/60 hover:bg-amber-300/60 text-amber-900 border-amber-300 rounded-full shadow-sm transition-all duration-300",
      section: "bg-white/80 backdrop-blur-sm rounded-3xl p-8 space-y-6 shadow-md border-2 border-amber-100",
      sectionTitle: "text-3xl font-semibold text-amber-900",
      card: "bg-white/90 border-amber-200 rounded-3xl shadow-sm hover:shadow-md",
      cardAccent: "bg-gradient-to-r from-amber-300 to-rose-300",
      cardTitle: "text-amber-900",
      textPrimary: "text-amber-900",
      textSecondary: "text-amber-700",
      iconColor: "text-rose-500",
      badge: "bg-rose-100 text-rose-700 border-rose-200 rounded-full",
      profileGlow: "bg-gradient-to-r from-amber-400 via-rose-400 to-pink-400",
      profileBorder: "border-4 border-rose-300",
      achievementBadge: "bg-gradient-to-r from-amber-500 to-rose-500",
    },
  };
          ...
          <div className="flex justify-center mb-6">
            <div className="relative">
              ...
              {studentData.achievementLevel && (
                <div className={`absolute -bottom-2 left-1/2 -translate-x-1/2 ${t.achievementBadge} text-white px-4 py-1 ${isWholesome ? 'rounded-full' : 'rounded-full'} text-sm font-bold shadow-lg border border-white/20`}>
                  ⭐ {studentData.achievementLevel}
                </div>
              )}
            </div>
