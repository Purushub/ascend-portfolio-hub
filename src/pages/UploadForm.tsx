...
export const UploadForm = () => {
  ...
  const maleAvatars = ['https://api.dicebear.com/7.x/avataaars/svg?seed=Felix&backgroundColor=b6e3f4', 'https://api.dicebear.com/7.x/avataaars/svg?seed=Max&backgroundColor=c0aede', 'https://api.dicebear.com/7.x/avataaars/svg?seed=Oliver&backgroundColor=d1d4f9', 'https://api.dicebear.com/7.x/big-smile/svg?seed=Charlie&backgroundColor=ffd5dc', 'https://api.dicebear.com/7.x/adventurer/svg?seed=James&backgroundColor=ffdfbf', 'https://api.dicebear.com/7.x/lorelei/svg?seed=Lucas&backgroundColor=b6e3f4'];
  const femaleAvatars = ['https://api.dicebear.com/7.x/avataaars/svg?seed=Aneka&backgroundColor=ffd5dc', 'https://api.dicebear.com/7.x/avataaars/svg?seed=Luna&backgroundColor=ffdfbf', 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sophie&backgroundColor=d1d4f9', 'https://api.dicebear.com/7.x/big-smile/svg?seed=Emma&backgroundColor=c0aede', 'https://api.dicebear.com/7.x/adventurer/svg?seed=Mia&backgroundColor=b6e3f4', 'https://api.dicebear.com/7.x/lorelei/svg?seed=Olivia&backgroundColor=ffd5dc'];
  ...
  return <div className="min-h-screen bg-gradient-to-b from-background to-secondary/20 py-12 px-4">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                {!selectedAvatar ? <div className="space-y-2">
                    <div className="flex items-center gap-4">
                      {profileImagePreview && <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-primary">
                    ...
                    <div className="flex gap-2 mb-4">
                      <Button type="button" variant={avatarGender === 'male' ? 'default' : 'outline'} onClick={() => setAvatarGender('male')} className="flex-1">
                        Male Avatars
                      </Button>
                      <Button type="button" variant={avatarGender === 'female' ? 'default' : 'outline'} onClick={() => setAvatarGender('female')} className="flex-1">
                        Female Avatars
                      </Button>
                    </div>
                    <div className="grid grid-cols-3 gap-4">
                      {avatarOptions.map((avatar, index) => <button key={index} type="button" onClick={() => setSelectedAvatar(avatar)} className={`w-full aspect-square rounded-2xl overflow-hidden border-2 transition-all hover:scale-105 ${selectedAvatar === avatar ? "border-primary ring-4 ring-primary/20 scale-105" : "border-muted"}`}>
                          <img src={avatar} alt={`Avatar ${index + 1}`} className="w-full h-full object-contain rounded-xl" />
                        </button>)}
                    </div>
                    {selectedAvatar && <div className="flex justify-center mt-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="schoolName" value={formData.schoolName} onChange={e => setFormData({
                  ...formData,
                ...
                <div className="space-y-2">
                  ...
                  <Input id="grade" value={formData.grade} onChange={e => setFormData({
                  ...formData,
                ...
                <div className="space-y-2">
                  ...
                  <Input id="year" value={formData.year} onChange={e => setFormData({
                  ...formData,
                  year: e.target.value
              ...
              <div className="space-y-2">
                ...
                <Textarea id="aboutMe" value={formData.aboutMe} onChange={e => setFormData({
                ...formData,
                aboutMe: e.target.value
              })} placeholder="Brief introduction about yourself..." rows={3} />
              </div>

              {/* Personal Bio */}
              <div className="space-y-2">
                <Label htmlFor="personalBio">Personal Bio</Label>
                <Textarea id="personalBio" value={formData.personalBio} onChange={e => setFormData({
                ...formData,
                personalBio: e.target.value
              })} placeholder="Share your story..." rows={4} />
              </div>

              {/* Core Strengths */}
              <div className="space-y-2">
                <Label htmlFor="coreStrengths">Core Strengths (comma separated)</Label>
                <Input id="coreStrengths" value={Array.isArray(formData.coreStrengths) ? formData.coreStrengths.join(", ") : ""} onChange={e => {
              ...
              <div className="space-y-2">
                ...
                <Input id="passions" value={Array.isArray(formData.passions) ? formData.passions.join(", ") : ""} onChange={e => {
                const value = e.target.value;
                setFormData({
                  ...formData,
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.theme || "minimal"} onValueChange={(value: any) => setFormData({
                ...formData,
                theme: value
              })}>
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.achievementLevel} onValueChange={(value: any) => setFormData({
                ...formData,
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.satReportType} onValueChange={(value: any) => setFormData({
                ...formData,
                satReportType: value
              })}>
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Input id="linkedinUrl" value={formData.linkedinUrl || ""} onChange={e => setFormData({
                ...formData,
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="archetypeTitle" value={formData.archetype?.title} onChange={e => setFormData({
                  ...formData,
                  archetype: {
                    ...formData.archetype!,
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="archetypeDescription" value={formData.archetype?.description} onChange={e => setFormData({
                  ...formData,
                  archetype: {
                    ...formData.archetype!,
                ...
                <div className="space-y-2">
                  ...
                  <Input id="archetypeQuote" value={formData.archetype?.quote} onChange={e => setFormData({
                  ...formData,
                  archetype: {
                    ...formData.archetype!,
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="socialEnergyType" value={formData.socialEnergyStyle?.type} onChange={e => setFormData({
                  ...formData,
                  socialEnergyStyle: {
                    ...formData.socialEnergyStyle!,
                    type: e.target.value
                  }
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="socialEnergyDescription" value={formData.socialEnergyStyle?.description} onChange={e => setFormData({
                  ...formData,
                  socialEnergyStyle: {
                    ...formData.socialEnergyStyle!,
                    description: e.target.value
              ...
              <div className="space-y-4 border-t pt-6">
                <div className="flex items-center justify-between">
                  ...
                  <Button type="button" variant="outline" size="sm" onClick={() => setProjects([...projects, {
                  title: "",
                  description: "",
                  skills: "",
                  tools: "",
                ...
                {projects.map((project, index) => <Card key={index} className="p-4">
                    <div className="space-y-4">
                      <div className="flex justify-between items-start">
                        <h4 className="font-medium">Project {index + 1}</h4>
                        <Button type="button" variant="ghost" size="sm" onClick={() => setProjects(projects.filter((_, i) => i !== index))}>
                          <X className="h-4 w-4" />
                        </Button>
                      </div>
                      <div className="space-y-2">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label>Skills</Label>
                          <Input value={project.skills} onChange={e => {
                        const newProjects = [...projects];
                        ...
                        <div className="space-y-2">
                          <Label>Tools</Label>
                          <Input value={project.tools} onChange={e => {
                        const newProjects = [...projects];
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input value={project.duration} onChange={e => {
                        const newProjects = [...projects];
                      ...
                      <div className="space-y-2">
                        ...
                        <Input value={project.achievement} onChange={e => {
                      const newProjects = [...projects];
                      ...
                      setProjects(newProjects);
                        ...
                        {project.images.length > 0 && <div className="flex gap-2 flex-wrap mt-2">
                            {project.images.map((img, imgIndex) => <div key={imgIndex} className="relative w-20 h-20">
              ...
              <div className="space-y-4 border-t pt-6">
                <div className="flex items-center justify-between">
                  ...
                  <Button type="button" variant="outline" size="sm" onClick={() => setCaseStudies([...caseStudies, {
                  title: "",
                  description: "",
                  skills: "",
                  duration: "",
                ...
                {caseStudies.map((caseStudy, index) => <Card key={index} className="p-4">
                    <div className="space-y-4">
                      <div className="flex justify-between items-start">
                        <h4 className="font-medium">Case Study {index + 1}</h4>
                        <Button type="button" variant="ghost" size="sm" onClick={() => setCaseStudies(caseStudies.filter((_, i) => i !== index))}>
                          <X className="h-4 w-4" />
                        </Button>
                      </div>
                      <div className="space-y-2">
                        <Label>Title</Label>
                        <Input value={caseStudy.title} onChange={e => {
                      ...
                      <div className="space-y-2">
                        <Label>Description</Label>
                        <Textarea value={caseStudy.description} onChange={e => {
                      const newCaseStudies = [...caseStudies];
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label>Skills</Label>
                          <Input value={caseStudy.skills} onChange={e => {
                        const newCaseStudies = [...caseStudies];
                        ...
                        <div className="space-y-2">
                          <Label>Duration</Label>
                          <Input value={caseStudy.duration} onChange={e => {
                        const newCaseStudies = [...caseStudies];
                      ...
                      <div className="space-y-2 border-l-2 border-primary/20 pl-4">
                        ...
                        {caseStudy.steps.map((step, stepIndex) => <Card key={stepIndex} className="p-3">
                            <div className="space-y-2">
                              <div className="flex justify-between items-start">
                          ...
                          setCaseStudies(newCaseStudies);
                              ...
                              <Textarea placeholder="Step description" value={step.description} onChange={e => {
                          const newCaseStudies = [...caseStudies];
              ...
              <div className="space-y-4 border-t pt-6">
                <div className="flex items-center justify-between">
                  ...
                  <Button type="button" variant="outline" size="sm" onClick={() => setExtracurricular([...extracurricular, {
                  title: "",
                  description: "",
                  skills: "",
                  duration: "",
                ...
                {extracurricular.map((activity, index) => <Card key={index} className="p-4">
                    <div className="space-y-4">
                      <div className="flex justify-between items-start">
                        <h4 className="font-medium">Activity {index + 1}</h4>
                        <Button type="button" variant="ghost" size="sm" onClick={() => setExtracurricular(extracurricular.filter((_, i) => i !== index))}>
                          <X className="h-4 w-4" />
                        </Button>
                      </div>
                      <div className="space-y-2">
                        <Label>Title</Label>
                        <Input value={activity.title} onChange={e => {
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label>Skills</Label>
                          <Input value={activity.skills} onChange={e => {
                        const newActivities = [...extracurricular];
                        ...
                        <div className="space-y-2">
                          <Label>Duration</Label>
                          <Input value={activity.duration} onChange={e => {
                        const newActivities = [...extracurricular];
                      ...
                      <div className="space-y-2 border-l-2 border-primary/20 pl-4">
                        ...
                        {activity.highlights?.map((highlight, highlightIndex) => <Card key={highlightIndex} className="p-3">
                            <div className="space-y-2">
                              <div className="flex justify-between items-start">
                            ...
                            setExtracurricular(newActivities);
                              ...
                              <Input placeholder="Title" value={highlight.title} onChange={e => {
                          const newActivities = [...extracurricular];
                          newActivities[index].highlights![highlightIndex].title = e.target.value;
                          setExtracurricular(newActivities);
                        }} />
                              <Textarea placeholder="Description" value={highlight.description} onChange={e => {
                          const newActivities = [...extracurricular];
